...
@implementation AnswerRequestProcessor
...
- (void) showNotificationAlert:(NSString*)message Title:(NSString*) title {
    ...
    [alert addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"Take a photo",@"Take a photo") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        // continue your work
